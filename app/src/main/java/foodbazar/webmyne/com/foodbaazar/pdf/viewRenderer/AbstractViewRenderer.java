...
import foodbazar.webmyne.com.foodbaazar.pdf.utils.MeasureUtils;
...
abstract public class AbstractViewRenderer implements IViewRenderer {
    ...
    final public Bitmap render(int width, int height) {
        ...
        int specWidth = View.MeasureSpec.makeMeasureSpec(width == 1 ? 2000 : width, width == 1 ? View.MeasureSpec.UNSPECIFIED : View.MeasureSpec.EXACTLY);
        int specHeight = View.MeasureSpec.makeMeasureSpec(height == 1 ? 2000 : height, height == 1 ? View.MeasureSpec.UNSPECIFIED : View.MeasureSpec.EXACTLY);
